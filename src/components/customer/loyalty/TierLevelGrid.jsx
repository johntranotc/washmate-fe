        ...
        {tiers.map((tier) => {
          ...
          return (
            ...
            >
              ...
              {isCurrent && (
                <span className="mt-3 rounded-full bg-secondary px-2.5 py-1 text-xs font-bold text-secondary-foreground">
                  Hạng hiện tại
                </span>
              )}
              ...
              <div className="mt-3 inline-flex items-center rounded-full px-3 py-1 text-xs font-bold text-primary-foreground" style={{ backgroundColor: tier.color }}>
                {tier.discount}
              </div>
            </Card>
          );
