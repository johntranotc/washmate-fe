...
import { bookingStatusLabels, normalizeBookingList, normalizeStaffBooking, paymentStatusLabels } from "@/lib/staff-booking-data";
              ...
              <tbody className="divide-y divide-slate-100">
                {visibleBookings.map((booking) => (
                  <tr key={booking.id}>
                    ...
                    <td className="p-4"><Link to={`/nhan-vien/danh-sach/${booking.id}`} className="inline-flex items-center gap-1 font-bold text-blue-600">Xem chi tiết <ArrowRight size={13} /></Link></td>
                  </tr>
                ))}
              </tbody>
            </table>
