...
export default function AdminDashboardPage() {
  ...
  useEffect(() => { adminApi.getAdminSummary().then((data) => setSummary({ ...[].summary, ...data })).catch(() => {}); }, []);
  const metrics = [
